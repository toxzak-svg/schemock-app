// Auto-generated from src/installer/ui/index.html
    ...
    <div class="installer-container">
        ...
        <div id="welcome-page" class="installer-content active welcome-page">
            ...
            <div class="system-requirements">
                ...
                <ul>
                    <li><span class="requirement-check">✓</span> Windows 10 or later (x64)</li>
                    <li><span class="requirement-check">✓</span> 512MB RAM minimum</li>
                    <li><span class="requirement-check">✓</span> 100MB free disk space</li>
                </ul>
            </div>
        </div>
    ...
    <script>
        ...
        async function init() {
            try {
                ...
                installerState = await stateRes.json();
        ...
        async function startInstallation() {
            try {
                ...
                if (result.success) {
                    ...
                    alert('Failed to start installation: ' + result.error);
                }
        ...
        function startProgressPolling() {
            progressInterval = setInterval(async () => {
                try {
                    ...
                    document.getElementById('installation-message').textContent = data.message;
                    ...
                    if (data.error) {
                        clearInterval(progressInterval);
                        alert('Installation error: ' + data.error);
                    }
                } catch (e) {
        ...
        function cancelInstallation() {
            if (currentPage === 'installation') {
                if (confirm('Are you sure you want to cancel the installation? The application will not be properly installed.')) {
                    closeInstaller();
                }
            } else {
                closeInstaller();
